...
const initialAuthToken = typeof __initial_auth_token !== 'undefined' ? initialAuthToken : null; // initialAuthToken düzeltildi
    ...
    useEffect(() => {
        if (db && userId && isAuthReady) {
            ...
            const unsubscribe = onSnapshot(q, (snapshot) => {
                ...
                if (!hasHistory && loadedMessages.length === 0) { // Sadece ilk yüklemede ve mesaj yoksa
                    setTimeout(() => {
